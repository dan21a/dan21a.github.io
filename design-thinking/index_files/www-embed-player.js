...
b=xi("//web.archive.org/web/20220213171857/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Lf&&b.abort();
return If(c)})}
...
function iq(){var a=window.location.protocol,b=Q.getEntriesByType("resource");b=eb(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20220213171857/https://fonts.gstatic.com/s/")});
...
try{kr("//web.archive.org/web/20220213171857/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}rr.push(Vh.N(function(){if(!(sr||"google_ad_status"in window)){try{qr("//web.archive.org/web/20220213171857/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}sr=!0;oh("DCLKSTAT",3)}},5E3))}}
...
B("PL_ATT")&&zr.dispose();for(var a=0,b=rr.length;a<b;a++)Vh.U(rr[a]);rr.length=0;pr("//web.archive.org/web/20220213171857/https://static.doubleclick.net/instream/ad_status.js");sr=!1;oh("DCLKSTAT",0);Xd(Ps,Os);Ns&&(Ns.removeEventListener("onVideoDataChange",Qs),Ns.destroy())});
...
/*
     FILE ARCHIVED ON 17:18:57 Feb 13, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:08:05 Jun 11, 2026.
...
playback timings (ms):
  ...
  load_resource: 140.76
  PetaboxLoader3.resolve: 102.785
  PetaboxLoader3.datanode: 29.168
*/